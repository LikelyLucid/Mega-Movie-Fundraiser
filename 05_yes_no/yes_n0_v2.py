def yes_no_response(question):
    ...
    valid_responses = ["y", "yes", "n", "nol response = input(question).lower() while response not in valid_responses: print(error_message) response = input(question).lower() I if response == "n" or response == "no": return False else: return True
